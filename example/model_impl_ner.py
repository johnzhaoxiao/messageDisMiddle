...
# @File    : model_impl_ner.py
# @Software: PyCharm
import os
import time
import random
import pickle
from messageDisMiddle.run_script.model import Model

class NER_Model_Impl(Model):
...
if __name__ == '__main__':
    ...
    ner_model_proxy = './ner_model.proxy'

    # dump model

    ner_model = NER_Model_Impl('ner')
